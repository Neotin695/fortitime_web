    ...
    <main className="xl:container px-2 md:px-4">
      ...
      <div
        className={clsx(
          ...
          parsedSettings?.ui_type === "3" && "gap-6 lg:mt-4"
        )}
      >
        <aside className="border-r border-gray-border dark:border-gray-bold min-h-[calc(100vh-174px)] hidden lg:block">
          <ProfileSidebar />
        </aside>
        {info}
        <div
