...
const SingleShop = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    <div className="xl:container px-2 md:px-4">
      <div className="relative md:h-[350px] h-60 w-full rounded-3xl overflow-hidden flex flex-col justify-end lg:pb-7 lg:px-7 md:pb-4 md:px-4 pb-2 px-2">
        ...
        />
        <h1 className="text-3xl font-bold z-[1] text-white mb-3">{shop.data.translation?.title}</h1>
