...
export const AdsCard = ({ data }: AdsCardProps) => (
  <div className="grid lg:grid-cols-6 md:gap-7 gap-4 relative">
    <div className="md:p-10 sm:p-5 p-3 lg:col-span-2 bg-primary rounded-xl bg-curve-pattern bg-no-repeat bg-cover lg:aspect-auto sm:aspect-[2/1] aspect-square">
      <div className="flex flex-col gap-2">
        <Link
          href={`/promotion/${data.id}`}
          className="lg:text-7xl text-5xl font-semibold text-white hover:underline"
        >
