...
export const CategoryFilter = ({ extra }: CategoryFilterProps) => {
  ...
  return (
    <div className="xl:container px-2 md:px-4 border-b border-gray-border dark:border-gray-inputBorder py-4 flex  justify-between min-w-0 mb-2 flex-col sm:flex-row sm:items-center gap-4 flex-col-reverse">
