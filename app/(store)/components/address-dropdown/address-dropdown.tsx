...
export const AddressDropdown = ({ rounded }: AddressDropdownProps) => {
      ...
      {({ open, close }) => (
        <>
          ...
          >
            <Popover.Panel
              static
              className="sm:absolute fixed sm:bottom-auto bottom-0 right-0 z-30 mt-2 lg:w-full lg:max-w-sm sm:w-72 w-screen transform "
            >
