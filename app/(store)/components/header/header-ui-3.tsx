...
export const HeaderUI3 = ({ settings }: { settings: Record<string, string> }) => (
  <header className="xl:px-4 py-4 px-2">
    <div className="xl:container py-4 px-2 bg-white dark:bg-darkBgUi3 rounded-xl">
      <div className="flex items-center justify-between gap-8 lg:px-5">
