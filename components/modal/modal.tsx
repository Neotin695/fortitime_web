...
export const Modal = ({
  ...
  const onRouteDismiss = useCallback(() => {
    router.back();
  }, [router]);
  const onDismiss = onClose || onRouteDismiss;
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-10" unmount onClose={() => onDismiss()}>
        <Transition.Child
          as={Fragment}
